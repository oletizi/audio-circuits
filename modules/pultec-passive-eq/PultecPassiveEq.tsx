 ...
 * recomposed.
 *
 * Scope matches the reference model: low cut, low boost and hi cut. The hi
 * boost resonant branch and the mid section are absent, so this is not the
 * whole EQ. See `reference/pultec/unresolved.md`.
 */
